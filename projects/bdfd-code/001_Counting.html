...
<head>
	...
	<title>Web by stefanuslie25</title>
	<link rel="icon" href="https://i.imgur.com/taLNQSv.png" type="image/png">
	<link rel="stylesheet" href="../..ttps://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css"/>
...
<body>
	...
	<div class="list-content">
		<div class="black-box-desc">
			...
			<p class="explanation">
				<span class="desc-bold">First:</span> You will need 2 variables.<br><br>
			...
			<p class="explanation">
				<span class="desc-bold">Second:</span> This only works for <span class="func">$alwaysReply</span> HAHAHA
				<p class="notes">For free users, I'll do it later! Please be patience :)</p>
			</p>
			<hr>
...
<pre  class="copy-box" readonly><code class="bdscript">$if[$getVar[countingUser]==$authorID]
	$c[Do something]
$else
	$c[Do something]
$endif
			...
			<p class="explanation">
				Then <span class="quote">optionally</span> warn him and deletes the warn message in 5 seconds using <span class="func">$deleteIn[</span><span class="argValue">5s</span><span class="func">]</span><br>(You can change the time to any time, read more about it <a href="https://nilpointer-software.github.io/bdfd-wiki/bdscript/deleteIn.html">here</a>)
			</p>
<pre  class="copy-box" readonly><code class="bdscript">$if[$getVar[countingUser]==$authorID]
	$deletecommand
...
<pre  class="copy-box" readonly><code class="bdscript">$if[$message[1]==$getVar[countingNumber]]
	$addCmdReactions[✅]
$endif
</code></pre>
		<p class="explanation">
...
<pre  class="copy-box" readonly><code class="bdscript">$if[$authorID!=$getVar[countingUser]]
	$if[$message[1]==$getVar[countingNumber]]
		$addCmdReactions[✅]
...
$endif</code></pre>
			<div class="button-in-box">
				<button onclick="copyAlert()" class="button">Copy me, senpai!</button>
			</div>
		</div>
		<div class="black-box-code">
			<h1>Another Version<br></h1>
			<p class="explanation">I added some more things here</p>
<pre  class="copy-box" readonly><code class="bdscript">$nomention
...
$endif</code></pre>
	...
	<div class="footer-with-button">
		<button onclick="window.location.href='list.html'" class="button">Back</button>
	</div>
	<div class="footer">
		<p>Made with github page and chatgpt. <span class="quote"><-- Why is it here tbh</span></p>
	</div>
<textarea id="textToCopy" class="hidden-text" readonly>$if[$authorID!=$getVar[countingUser]]
	$if[$message[1]==$getVar[countingNumber]]
		$addCmdReactions[✅]
		$setVar[countingNumber;$calculate[$getVar[countingNumber]+1]]
		$setVar[countingUser;$authorID]
